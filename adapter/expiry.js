...
const STARTER = {
  ...
  restaurant: [['손질 채소(양파 · 대파)', 'cold', 'days', 3, 0, '봉', 0, '냉장고'], ['쌈채소(상추 · 깻잎)', 'cold', 'days', 3, 0, '박스', 0, '냉장고'], ['두부', 'cold', 'label', 7, 1, '모', 1500, '냉장고'], ['돼지고기(생)', 'cold', 'days', 3, 0, 'kg', 0, '냉장고'], ['해산물(생)', 'cold', 'days', 1, 0, 'kg', 0, '냉장고'], ['직접 끓인 육수', 'cold', 'days', 2, 0, '통', 0, '냉장고'], ['소스 · 양념', 'cold', 'label', 90, 30, '통', 0, '냉장고'], ['쌀', 'room', 'label', 180, 60, '포', 0, '창고']],
